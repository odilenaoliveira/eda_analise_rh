...
with st.container():
    ...
    g1.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g2.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g3.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g4.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g5.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g6.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g7.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g8.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g9.tick_params(axis='x', labelsize=12,rotation=90)
...
with st.container():
    ...
    g10.tick_params(axis='x', labelsize=12,rotation=90)
